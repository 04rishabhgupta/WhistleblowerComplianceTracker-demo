      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <Link href="/users" className={buttonVariants({ variant: 'link', className: "px-0 mt-2 h-auto text-xs text-blue-600" })}>
              Manage Users →
            </Link>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Link href="/settings" className={buttonVariants({ variant: 'link', className: "px-0 mt-2 h-auto text-xs text-blue-600" })}>
              View Tenants →
            </Link>
          </CardContent>
        </Card>
